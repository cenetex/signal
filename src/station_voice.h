...
static const char *STATION_ONBOARD[3][VOICE_ONBOARD_COUNT] = {
    /* Prospect Refinery — terse, practical */
    {
        ...
        /* MINE    */ "Belt's hot. Hold [M] on a rock. Start small.",
        ...
        /* PLACE_T */ "Find your scaffold near the yard. Grab it with [Space].",
    ...
    /* Kepler Yard — technical, trails off */
    {
        ...
        /* MINE    */ "Asteroids are fragile. Hold [M] to crack one.",
        ...
        /* PLACE_T */ "Scaffold's ready. Grab it with [Space] outside.",
    ...
    /* Helios Works — enthusiastic, ambitious */
    {
        ...
        /* MINE    */ "Rich veins out there. Hold [M] on a big one.",
        ...
        /* PLACE_T */ "Your scaffold's waiting. Grab it with [Space].",
