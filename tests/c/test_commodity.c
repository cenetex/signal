...
TEST(test_commodity_ore_form) {
    ...
    ASSERT_EQ_INT(commodity_ore_form(COMMODITY_LASER_MODULE), COMMODITY_CRYSTAL_ORE);
    ASSERT_EQ_INT(commodity_ore_form(COMMODITY_TRACTOR_MODULE), COMMODITY_CUPRITE_ORE);
