...
TEST(test_ws_backpressure_fixture_requires_explicit_opt_in) {
    ...
    ASSERT(WS_BACKPRESSURE_FIXTURE_STATION_COUNT <=
           SIGNAL_SEEDED_STATION_COUNT);
    ASSERT_EQ_INT(WS_BACKPRESSURE_FIXTURE_STATION0_DETAILS, 240);
    ASSERT(WS_BACKPRESSURE_FIXTURE_STATION0_DETAILS <=
           STATION_MANIFEST_DEFAULT_CAP);
    ASSERT(WS_BACKPRESSURE_FIXTURE_STATION0_DETAILS <=
           MANIFEST_DETAIL_MAX);
    ASSERT(WS_BACKPRESSURE_FIXTURE_OTHER_STATION_FRAMES <=
           STATION_MANIFEST_DEFAULT_CAP);
    ASSERT(WS_BACKPRESSURE_FIXTURE_OTHER_STATION_FRAMES <=
           MANIFEST_DETAIL_MAX);
}
