...
TEST(test_authored_cell_layouts_use_one_connected_grammar) {
    ...
    ASSERT_EQ_INT(totals.struts, 21); /* 3 hex rims + 1 triangle */
    ...
    ASSERT_EQ_INT(cost.struts, 21);
    ASSERT_EQ_INT(cost.ingots_to_press, 6);
    ASSERT_EQ_INT(cost.fragments_to_smelt, 2);
    ASSERT_EQ_FLOAT(cost.fragment_equivalent, 1.3125f, 0.0001f);
